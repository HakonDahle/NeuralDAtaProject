...
def show_ASDR_discussion(ASDR_Gen,ASDR_Comp1):
    pfig = plt.figure()
    ax = plt.subplot()
    ax.tick_params(axis='both', which='major', labelsize=26)

    Gen = plt.plot(ASDR_Gen,label='Generated data')
    Comp1 = plt.plot(ASDR_Comp1,label='Reference data')
...
show_ASDR_discussion(ASDR_Gen8_fit6,ASDR_data)